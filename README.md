...
pageTitle: "Just something I made!" // Browser tab title
...
questions: {
    first: {
        text: "Are we friends?",                   // First question
        yesBtn: "More than friends",                             // Yes button text
        noBtn: "No.",                               // No button text
        secretAnswer: "Hey sweetpea!~"  // Hidden message
    },
    second: {
        text: "How much do you love me?",          // Second question
        startText: "This much!",                   // Text before percentage
        nextBtn: "If you hate me up that much, we could move on"                         // Next button text
    },
    third: {
...
// Love Meter Messages
loveMessages: {
    extreme: "OML YOU WANT ME THAT BAD, YOU FLATTER ME",  // Shows above 5000%
    high: "I Mean sure.. thats nice",              // Shows above 1000%
    normal: "Really?..."                           // Shows above 100%
}
